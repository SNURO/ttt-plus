...
// @author       You
// @include        https://sugang.snu.ac.kr/*
...
function redirectToTargetURL() {
    const liElement = document.querySelector("#course_info_detail_22 > ul > li.state");
    //targeted : 22, test : 25
    ...
    if (spanElement) {
        ...
        //check the checkbox
        var desiredInput = document.querySelector('label.cc-check-item.round.full input[value="소프트웨어 개발의 원리와 실습"]');
        var checkboxElement = desiredInput.closest('label.cc-check-item.round.full');
